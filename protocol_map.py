...
| Yún T6 compile/upload | `arduino-cli compile/upload --fqbn arduino:avr:yun ...` | dual USB/Serial1 transport, ownership, motion, limits, and E-STOP use 20,794 bytes/72% flash and 1,399 bytes/54% RAM; stopped USB/LAN heartbeat reports no owner/motion and clear limits | Yún USB plus trusted WLAN; compile/upload and stopped LAN boot pass; motion qualification pending |
